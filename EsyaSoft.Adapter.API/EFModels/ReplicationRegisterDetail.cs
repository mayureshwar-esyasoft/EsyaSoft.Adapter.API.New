...
public partial class ReplicationRegisterDetail
{
    public long ReplicationRegisterDetailId { get; set; }

    public Guid ReplicationRegisterDetailAltId { get; set; }
    ...
    public bool RegisterDeviceAssignmentListCompleteTransmissionIndicator { get; set; }
